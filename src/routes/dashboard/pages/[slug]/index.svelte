...
<div class="col-span-6 sm:col-span-3 m-4">
	...
	<select id="template" on:change={(event) => fieldUpdate(event, pageData.data)} bind:value={currentTemplate} class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
